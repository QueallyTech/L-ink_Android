...
public class DragGridView extends GridView {
    ...
    public DragGridView(final Context context) {
        this(context, null);
    }

    public DragGridView(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DragGridView(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (isForward) {
            for (int pos = oldPosition; pos < newPosition; pos++) {
                ...
                if ((pos + 1) % mNumColumns == 0) {
                    resultList.add(createTranslationAnimations(view, -(view.getWidth() + mHorizontalSpacing) * (mNumColumns - 1), 0, view.getHeight() + mVerticalSpacing, 0));
                } else {
                    resultList.add(createTranslationAnimations(view, view.getWidth() + mHorizontalSpacing, 0, 0, 0));
                }
            }
        } else {
            for (int pos = oldPosition; pos > newPosition; pos--) {
